...
import { readSelectedShippingMethod } from '@/lib/commerce';
...
export default function CheckoutPage() {
  ...
  const checkout = useMutation({
    mutationFn: () => storeApi.checkout({ address_id: addressId!, payment_method: 'card', shipping_method: readSelectedShippingMethod() }),
      ...
      <main className="mx-auto max-w-5xl px-4 py-8">
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_360px]">
          ...
          <aside className="glass h-fit rounded-xl p-5">
            ...
            <p className="mt-2 text-xs text-graphite">O frete selecionado no resumo sera gravado no pedido.</p>

  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-7xl px-4 py-8">
        ...
        <section className="mt-10"><h2 className="mb-4 text-xl font-black">Produtos relacionados</h2><ProductGrid products={(related.data ?? []).filter((item) => item.id !== product.id)} /></section>
      </main>
      <Footer />
    </>
  );

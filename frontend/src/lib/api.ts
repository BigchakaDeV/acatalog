...
function resolveApiBaseUrl() {
  ...
  if (typeof window !== 'undefined') {
    ...
    return `${protocol}//${backendHost}${port}/api`;
  }
...
export const storeApi = {
  ...
  checkout: (payload: { address_id: number; payment_method: string; shipping_method?: string }) => api.post<Order>('/orders/checkout/', payload).then((r) => r.data),
